package com.kerebus.draw3d.command
{
	...
	public class PenStroke extends DrawCommandBase implements IDrawCommand
	{
		...
		public function PenStroke(graphics3d : Graphics3d, mouseModel : MouseInfo, toolModel : DrawDataModel)
		{
			_g3d = graphics3d;
